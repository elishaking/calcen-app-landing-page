            ...
            <h1>
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
                <g id="logo" transform="translate(-248 -123)">
                  ...
                  <text id="r_Θ" data-name="r∠Θ" transform="translate(256 154)" fill="#fff" font-size="18" fontFamily="Rubik-Medium, Rubik" fontWeight="500"><tspan x="0" y="0">r</tspan><tspan y="0" fontFamily="SegoeUISymbol, Segoe UI Symbol" fontWeight="400">∠</tspan><tspan y="0" fontFamily="SegoeUI-Semibold, Segoe UI" fontWeight="600">Θ</tspan></text>
                </g>
              </svg>
